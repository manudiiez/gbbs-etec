const Foros = [
    {
        ...
        img: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/22/Amateurfunkstation.jpg/200px-Amateurfunkstation.jpg',
...
export const dataForos = new Promise((resolve, reject) => {
